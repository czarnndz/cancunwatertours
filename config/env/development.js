...
process.env.facebook_clientID = '975412445838967';
process.env.facebook_clientSecret = '310fcd71a36a13d0bbeddeed73ac56a8';
process.env.facebook_callback = 'http://localhost:1337/fb_callback';
